...
from NET.self_attention_layers.self_attention_layers import position_attention_module
...
def deeplabv3_DA(inputs, args, is_training, reuse):

    # mean subtraction normalization
    #inputs = inputs - [_R_MEAN, _G_MEAN, _B_MEAN]

    # inputs has shape - Original: [batch, 256, 256, 4]
