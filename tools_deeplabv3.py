...
def get_loss_pre_metrics(x, y, is_training, batch_size, args):
    ...
    # 前向传播
    logits = tf.cond(is_training, true_fn=lambda: deeplab_v3.deeplab_v3(x, args, is_training=True, reuse=False),
                     false_fn=lambda: deeplab_v3.deeplab_v3(x, args, is_training=False, reuse=True))
