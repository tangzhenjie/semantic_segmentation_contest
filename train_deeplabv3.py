...
parser.add_argument('--end_learning_rate', type=float, default=5e-6,
...
def main():
    ...
    loss, train_op, metrics = tools_deeplabv3.get_loss_pre_metrics(x, y, is_train, batch_size, args)
        ...
        for epoch in range(EPOCHS):
            ...
            for step in range((epoch * train_batches_of_epoch), ((epoch + 1) * train_batches_of_epoch)):
                ...
                if (step + 1) % 625 == 0:
                    ...
                    kappa = tools_deeplabv3.kappa(con_matrix)
